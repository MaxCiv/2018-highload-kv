...
public class DeleteCall extends MethodFutureCall<Response> {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(DeleteCall.class);
    ...
    private Response delete() {
        try {
            ...
            LOGGER.error("Error while call remote DELETE request to {}", getNode().getConnectionString(), e);
